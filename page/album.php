            ...
            <div class="card-body">
               ...
               if ($submit=='Simpan') {
                  ...
                  if($hapus){
                     ...
                     echo  "<script>alert('Gagal Hapus Album')</script>";
                     echo '<meta http-equiv="refresh" content="0.8; url=?url=album">';
                  }
               }
               ...
               <table class="table table-hovered">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="?url=album&&edit&&albumid=<?= $album['AlbumID'] ?>
                           " class="btn btn-sm btn-warning">Edit</a>
                           <a href="?url=album&&hapus&&albumid=<?= $album['AlbumID'] ?>
                           " class="btn btn-sm btn-danger">Hapus</a>
                           <a href="?url=kategori&&albumid=<?= $album['AlbumID'] ?>
                           " class="btn btn-sm btn-success">Lihat Foto</a>
                        </td>
                     </tr>
                     <?php endforeach; ?>
                  </tbody>
