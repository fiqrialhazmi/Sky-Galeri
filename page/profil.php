<div class="container">
    <div class="row justify-content-center">
        <div class="col-7">
            <div class="card">
                <div class="card-body">
                <img class='img img-responsive rounded-circle mb-3' width='160' src='assets/img/bgsky.png'>
                    ...
                    <?php else : ?>
                        <div class="table-responsive">
                            <table class="table table-white table-hover">
                                <tr>
                                    <th style="width: 20%;" class="py-3"> <i class='fas fa-user-alt'></i>Nama</th><th>:</th>
                                    <td class="py-3 text-muted"><?= $user['NamaLengkap'] ?></td>
                                </tr>
                                <tr>
                                    <th style="width: 20%;" class="py-3"><i class="fa fa-envelope"></i>Email</th><th>:</th>
                                    <td class="py-3 text-muted"><?= $user['Email'] ?></td>
                                </tr>
                                <tr>
                                    <th style="width: 20%;" class="py-3"> <i class='fas fa-user-alt'></i>Username</th><th>:</th>
                                    <td class="py-3 text-muted"><?= $user['Username'] ?></td>
                                </tr>
                                <tr>
                                    <th style="width: 20%;" class="py-3"> <i class='fas fa-map-marker-alt'></i>Alamat</th><th>:</th>
